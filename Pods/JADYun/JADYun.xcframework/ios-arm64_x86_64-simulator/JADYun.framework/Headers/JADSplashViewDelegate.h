...
/**
 * @brief 视频广告player播放状态更新回调
 * @param videoPlayerStatus : video player status
 * @discussion 视频广告 : player播放状态更新
 */
- (void)jadSplashView:(JADSplashView *)splashView videoPlayerStatusChanged:(JADVideoPlayerStatus)videoPlayerStatus;

/**
 * @brief 视频广告播放失败回调
 * @param error : the reason of error
 * @discussion 视频广告 : 播放失败
 */
- (void)jadSplashView:(JADSplashView *)splashView videoPlayerError:(NSError *__nullable)error;
